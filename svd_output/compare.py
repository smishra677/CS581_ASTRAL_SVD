...
print(compareTreesFromPath('astral.tre','true-species.tre'))

print(compareTreesFromPath('svdquartets.tre','true-species.tre'))


print(compareTreesFromPath('out_svd.tre','true-species.tre'))


print(compareTreesFromPath('astral_7_4.tre','true-species_7_4.tre'))

print(compareTreesFromPath('svdquartets_7_4.tre','true-species_7_4.tre'))


print(compareTreesFromPath('out_svd_7_4.tre','true-species_7_4.tre'))
